...
N = 10; %total number of boards in the game (number of pieces will be N-1.)
...
TimeDelay=.2; %Time delay of dropping piece (lower number=faster, only used when S_Plot=1)
